...
基于【微信公众号文章+ChatGPT】的知识库问答工具

## 为什么做这个

微信公众号文章是我获取偏深度信息的主要渠道，我希望获得「ChatGPT能基于我收藏的文章和我对话」的体验（即类似NotebookLM的体验）
由于一些特殊原因，我的电脑不能下载微信客户端，为了实现这个体验，需要我跨设备操作+多次手动操作：
1. 手机复制文章的链接
2. 手机发送链接给自己的电脑
3. 电脑上打开文章链接
4. 复制全文内容
...
由于想要把这复杂的工作流简化，因此做了Article Collector，核心理念是尽可能减少这个过程中的手动操作+无需跨设备操作+实时生效
